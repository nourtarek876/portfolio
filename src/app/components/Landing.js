        ...
        <div className="land-about" >
          ...
          <div className="about-content">
            <p>
              ...
              elementum neque vitae lectus auctor, id tempor metus porttitor.
              Phasellus tristique sapien id metus vulputate, quis dapibus justo
              facilisis. Curabitur vulputate, purus at sollicitudin
              sollicitudin, odio metus auctor velit, at aliquam nisi ex a metus.
              Sed ut eros id erat consequat faucibus. Pellentesque habitant
              morbi tristique senectus et netus et malesuada fames ac turpis
              egestas. Vivamus vestibulum, nisi sit amet laoreet volutpat, magna
              urna sodales ex, in fermentum libero justo eu odio. Praesent
              cursus, nisl ac efficitur ultrices, purus neque porttitor turpis,
              sed consectetur nisi orci in lorem.
            </p>
            <Image
              className="about-img"
              src="/me1.jpg"
          ...
          <div className="clr-fll">
            <button type="button" class="btn">
              ...
              <div class="title">
                ...
                <strong class="description">Hire Me</strong>
                <span class="thunder">⚡</span>
              </div>
              <div class="glass">
