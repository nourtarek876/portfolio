  ...
  return (
    <>
      ...
      <div className="contact-landing">
        <div className="contact-info">
          <div className="info">
            ...
            <h1>phone number : +(20) 0102 101 0148</h1>
          </div>
          <div className="info">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="mailto:nourelhorany32@gmail.com">
              <h1>inbox me : nourelhorany32@gmai.com</h1>
            </a>
          </div>
          <div className="info">
            <svg
            ...
            <h1>Whatsapp : +(20) 0155 963 6731</h1>
          </div>
        </div>
      </div>
      {/* end contact */}
      ...
      <div className="footer">
        <div className="copy-write">© 2024 NOURTAREk ALL rights reserved.</div>{" "}
